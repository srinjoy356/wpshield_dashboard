...
export async function GET(request: Request) {
  try {
    ...
    // Accept period query parameter (7, 30, 90 days), default 30
    ...
    // 4. Top 5 attacking IPs (Grouped and ordered in JS to be safe and robust)
